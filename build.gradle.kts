...
graalvmNative {
    binaries {
        ...
        named("main") {
            ...
            buildArgs.add("--initialize-at-build-time=kotlinx.serialization.json.Json,kotlinx.serialization.json.JsonImpl,kotlinx.serialization.modules.SerializersModuleKt")
